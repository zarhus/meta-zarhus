...
SRC_URI = "git://github.com/Mbed-TLS/mbedtls.git;protocol=https;branch=mbedtls-3.6 \
	...
	file://run-ptest \
        file://0001-Add-RSA-alt-using-PKCS-11-API.patch"
...
CFLAGS:append = "${@bb.utils.contains('PACKAGECONFIG', 'psa', ' -DMBEDTLS_USE_PSA_CRYPTO', '', d)} -DMBEDTLS_RSA_ALT -Wno-unused-parameter -lckteec -g3 -O0"
